    ...
    for X_Si_0 in X_Sis:
        for X_O_0 in X_Os:    
            ...
            try:
                ...
                pl.params.reactions.fit_SiO2_a = 10.
                pl.params.reactions.fit_SiO2_b = 0.
                pl.params.reactions.fit_SiO2_c = 0.
                
                pl.params.reactions.ParamCitationMgO = 'from_params'
                pl.params.reactions.fit_MgO_a = 10.
                pl.params.reactions.fit_MgO_b = 0.
                pl.params.reactions.fit_MgO_c = 0.
